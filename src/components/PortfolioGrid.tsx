...
const projects = [
  {
    ...
    caseStudy: {
      ...
      problem: "احتاج مجمع ساكن إلى هوية بصرية فاخرة تعبر عن حلول الإسكان المؤسسي المتميز للشركات والكوادر التنفيذية.",
      solution: "تطوير نظام بصري راقٍ يعتمد على لوحة ألوان ترابية فاخرة مستوحاة من البيئة الطبيعية والعمارة العصرية، مع تطبيقات متكاملة.",
      results: "تعزيز مكانة ساكن كوجهة أولى للإسكان المؤسسي لكبرى الشركات الصناعية في الجبيل."
    },
  },
  {
    id: 19,
